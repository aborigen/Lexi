...
const translations: Record<string, Record<TranslationKeys, string>> = {
  en: {
    ...
    get_hint: 'GET HINT',
    analyzing: 'THINKING',
    strategy_identified: 'HINT FOUND',
    wait_ai: 'Stuck? The AI can find hidden combinations.',
  ...
  ru: {
    ...
    get_hint: 'ПОДСКАЗКА',
    analyzing: 'ДУМАЕТ...',
    strategy_identified: 'ПОДСКАЗКА ГОТОВА',
    wait_ai: 'Застряли? ИИ найдет скрытые комбинации.',
